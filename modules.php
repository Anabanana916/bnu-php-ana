<?php
   ...
   if (isset($_SESSION['id'])) {
      ...
      $data['content'] .= "<table border='1' class='mt-3 table table-striped-columns table-hover table-bordered border-dark'>";
      $data['content'] .= "<tr><th colspan='5' align='center' class='table-primary table border-dark'>Modules</th></tr>";
      $data['content'] .= "<tbody class='table-group-divider'>";
